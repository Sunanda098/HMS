...
class IndimediDietplan(models.Model):
    _name = "hms.dietplan"
...
class IndimediSurgery(models.Model):
    ...
    diseases= fields.Many2one ('hms.diseases', ondelete='restrict', string='Base condition', help="Base Condition / Reason")
    ...
    surgeon = fields.Many2one('hms.physician', ondelete='restrict', string=' Primary Surgeon', help="Surgeon who did the procedure")

...
class StockProductioLot(models.Model):
    ...
    def _onchange_life_date(self):
        if self.life_date:
            self.removal_date = ((datetime.strptime(self.life_date, "%Y-%m-%d %H:%M:%S")) + timedelta(days= -90)).strftime("%Y-%m-%d %H:%M:%S")
            self.use_date = ((datetime.strptime(self.life_date, "%Y-%m-%d %H:%M:%S")) + timedelta(days= -90)).strftime("%Y-%m-%d %H:%M:%S")
            self.alert_date = ((datetime.strptime(self.life_date, "%Y-%m-%d %H:%M:%S")) + timedelta(days= -90)).strftime("%Y-%m-%d %H:%M:%S")
        else:

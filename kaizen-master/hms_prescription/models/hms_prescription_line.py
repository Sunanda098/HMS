...
class IndimediPrescriptionLine(models.Model):
    ...
    patient_id = fields.Many2one('hms.patient', related="prescription_id.patient_id", string='Patient')
    ...
    indication = fields.Many2one('hms.diseases', ondelete="restrict", string='Disease', help='Choose a disease for this medicament from the disease list. It'\
    ...
    medicine_type = fields.Many2one('drug.form', string='Type')
    suffix_freq_id = fields.Many2one('medication.dosage', string='Advice')
    time_interval = fields.Char(string='Day')
    sub_frequency_id = fields.Many2one('medication.dosage', string="Instruction")
    ...
    def onchange_common_dosage(self):
        print "==============common_dosage===========",self.common_dosage.code

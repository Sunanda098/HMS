...
class Investigation(models.Model):
    ...
    patient_id = fields.Many2one('hms.patient', string = 'Patient', states = {'cancel': [('readonly', True)], 'done': [('readonly', True)]})
    ...
    doctor_id = fields.Many2one('hms.physician', string = 'Prescribing Doctor', states = {'cancel': [('readonly', True)], 'done': [('readonly', True)]})
    ...
    invoice_id = fields.Many2one('account.invoice', string = 'Invoice', states = {'cancel': [('readonly', True)], 'done': [('readonly', True)]})
    ...
    amount_total = fields.Float(string = 'Charges', store = True, readonly = True, compute = '_amount_all', track_visibility = 'always')

...
class Consent(models.Model):
    ...
    consent_patient_name = fields.Many2one('hms.patient', ondelete="restrict", string='Patient')
    ...
    consent_form_type = fields.Selection([('blood_consent', 'Blood Consent'), ('c_colonoscopy', 'C-COLONOSCOPY'), ('Consent_form_for_transfusion_of_Blood_&_blood_products', 'Consent form for transfusion of Blood & blood products'), ('high_risk_consent', 'High Risk consent'), ('icu_admission_consent', 'ICU Admission consent'), ('informed_consent_costly', 'Informed consent costly'), ('stoma', 'Stoma'), ('intubation', 'Intubation'), ('team_admission', 'Team admission'), ('C_UPPER_GASTROINTESTINAL_ENDOSCOPY_DILATATION', 'C - UPPER GASTROINTESTINAL ENDOSCOPY DILATATION'), ('C_UPPER_GASTROINTESTINAL_ENDOSCOPY_FOR_BLEEDING','C - UPPER GASTROINTESTINAL ENDOSCOPY FOR BLEEDING'), ('C_UPPER_GASTROINTESTINAL_ENDOSCOPY_VARICEAL_BANDING_(OR_GLUEING)', 'C - UPPER GASTROINTESTINAL ENDOSCOPY  VARICEAL BANDING (OR GLUEING)'),('C_SIGMOIDOSCOPY','C - SIGMOIDOSCOPY'),('Discharge_on_Request_(DOR)', 'Discharge on Request (DOR)')], string='C-Type')

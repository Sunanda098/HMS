...
#         details = self.browse(self.id).item_ids
#         for detail in details:
#             detail.lot_id.write({'qty_lot':  detail.lot_id.qty_lot+detail.quantity})
...
class StockProductionLot(models.Model):
    ...
    locked = fields.Boolean(string='Blocked', default='_get_locked_value',
                            readonly=True)
    qty_count = fields.Boolean('Quantity Counting')
    qty_lot = fields.Float(string='Quantity', readonly=True)

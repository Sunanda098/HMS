...
class MatterClaim(models.Model):
    ...
    claim_amount = fields.Float(string="Total Claim Amount")
    paid_amount = fields.Float(string="Amount to be Paid as Per Judgement")
    ...
    remainig_claim_amount_count = fields.Float(string="Remainig Amount", compute="count_remainig_amount", readonly=True)

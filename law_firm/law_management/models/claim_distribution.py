...
class ClaimDistribution(models.Model):
    ...
    remain_amount_court = fields.Float(string="Remaining Amount to court", compute="_compute_remain_amount_court")
    ...
    paid_amount_client = fields.Float(string="Paid Amount to client till date", compute="_compute_remain_amount_court")
    remain_amount_client = fields.Float(string="Remaining Amount to client", compute="_compute_remain_amount_court")

...
class ProjectTask(models.Model):
    ...
    case_id = fields.Many2one("matter.matter", string="Case")
    assign_to = fields.Selection([('lawyer','Lawyer'),('judge','Judge'),('court_admin','Court Admin'),('registry_clerk','Registry Clerk')],string="Assign To")   
    ...
    registry_clerk = fields.Many2one("case.clerk", string=" Registry Clerk") 

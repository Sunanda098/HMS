...
""",
    ...
    'data': [
            ...
            'data/sequence.xml',
            'data/trail_scheduler_lawyer.xml',
            'data/trail_scheduler_client.xml',
            'data/task_scheduler_for_lawyer.xml',
            'data/trail_email_notification_lawyer.xml',
            'data/trail_email_notification_client.xml',
            'data/lawyer_task_notification_email_template.xml',
